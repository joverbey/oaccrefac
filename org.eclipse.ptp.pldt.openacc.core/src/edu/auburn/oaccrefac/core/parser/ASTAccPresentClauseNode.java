...
public class ASTAccPresentClauseNode extends ASTNode implements IAccDataClause, IAccDeclareClause, IAccKernelsClause, IAccKernelsLoopClause, IAccParallelClause, IAccParallelLoopClause
{
    Token hiddenLiteralStringPresent; // in ASTAccPresentClauseNode
    Token hiddenLiteralStringLparen; // in ASTAccPresentClauseNode
    IASTListNode<ASTAccDataItemNode> accDataList; // in ASTAccPresentClauseNode
    Token hiddenLiteralStringRparen; // in ASTAccPresentClauseNode
    ...
    {
        visitor.visitASTAccPresentClauseNode(this);
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return this.hiddenLiteralStringPresent;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hiddenLiteralStringPresent = (Token)value; if (value != null) value.setParent(this); return;
