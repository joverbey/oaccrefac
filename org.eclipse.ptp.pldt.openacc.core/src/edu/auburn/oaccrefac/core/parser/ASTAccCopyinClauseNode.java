...
public class ASTAccCopyinClauseNode extends ASTNode implements IAccDataClause, IAccDeclareClause, IAccEnterDataClause, IAccKernelsClause, IAccKernelsLoopClause, IAccParallelClause, IAccParallelLoopClause
{
    Token hiddenLiteralStringCopyin; // in ASTAccCopyinClauseNode
    Token hiddenLiteralStringLparen; // in ASTAccCopyinClauseNode
    IASTListNode<ASTAccDataItemNode> accDataList; // in ASTAccCopyinClauseNode
    Token hiddenLiteralStringRparen; // in ASTAccCopyinClauseNode
    ...
    {
        visitor.visitASTAccCopyinClauseNode(this);
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return this.hiddenLiteralStringCopyin;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hiddenLiteralStringCopyin = (Token)value; if (value != null) value.setParent(this); return;
