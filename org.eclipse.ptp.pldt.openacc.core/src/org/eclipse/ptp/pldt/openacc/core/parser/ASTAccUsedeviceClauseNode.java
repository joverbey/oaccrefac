...
public class ASTAccUsedeviceClauseNode extends ASTNode implements IAccHostdataClause
{
    Token hiddenLiteralStringUseUnderscoredevice; // in ASTAccUsedeviceClauseNode
    Token hiddenLiteralStringLparen; // in ASTAccUsedeviceClauseNode
    IASTListNode<ASTIdentifierNode> identifierList; // in ASTAccUsedeviceClauseNode
    Token hiddenLiteralStringRparen; // in ASTAccUsedeviceClauseNode
    ...
    {
        visitor.visitASTAccUsedeviceClauseNode(this);
        visitor.visitIAccHostdataClause(this);
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return this.hiddenLiteralStringUseUnderscoredevice;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hiddenLiteralStringUseUnderscoredevice = (Token)value; if (value != null) value.setParent(this); return;
