...
public class ForLoopDependenceSystem {
     ...
     * 
     * @param statement
     *            the statement the dependence exists on
     * @return the dependence
     */
    public DataDependence getDependence(IASTExpressionStatement statement1, IASTExpressionStatement statement2,
            DependenceType type) {
    ...
    public Set<Direction[]> getPossibleDependenceDirections() {
        ...
        int nestingLevel = 4;
        Direction[] allDirections = new Direction[nestingLevel];
