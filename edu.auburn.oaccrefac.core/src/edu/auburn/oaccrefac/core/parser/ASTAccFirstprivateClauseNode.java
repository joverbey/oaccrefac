...
public class ASTAccFirstprivateClauseNode extends ASTNode implements IAccParallelClause, IAccParallelLoopClause
{
    Token hiddenLiteralStringFirstprivate; // in ASTAccFirstprivateClauseNode
    Token hiddenLiteralStringLparen; // in ASTAccFirstprivateClauseNode
    IASTListNode<ASTAccDataItemNode> accDataList; // in ASTAccFirstprivateClauseNode
    Token hiddenLiteralStringRparen; // in ASTAccFirstprivateClauseNode
    ...
    {
        visitor.visitASTAccFirstprivateClauseNode(this);
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return this.hiddenLiteralStringFirstprivate;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hiddenLiteralStringFirstprivate = (Token)value; if (value != null) value.setParent(this); return;
