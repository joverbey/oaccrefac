...
public class ASTAccGangClauseNode extends ASTNode implements IAccKernelsLoopClause, IAccLoopClause, IAccParallelLoopClause, IAccRoutineClause
{
    Token hiddenLiteralStringGang; // in ASTAccGangClauseNode
    Token hiddenLiteralStringLparen; // in ASTAccGangClauseNode
    IConstantExpression count; // in ASTAccGangClauseNode
    Token hiddenLiteralStringRparen; // in ASTAccGangClauseNode
    ...
    {
        visitor.visitASTAccGangClauseNode(this);
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return this.hiddenLiteralStringGang;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hiddenLiteralStringGang = (Token)value; if (value != null) value.setParent(this); return;
