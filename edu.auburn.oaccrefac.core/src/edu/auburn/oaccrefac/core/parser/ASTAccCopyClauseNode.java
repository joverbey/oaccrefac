...
public class ASTAccCopyClauseNode extends ASTNode implements IAccDataClause, IAccDeclareClause, IAccKernelsClause, IAccKernelsLoopClause, IAccParallelClause, IAccParallelLoopClause
{
    Token hiddenLiteralStringCopy; // in ASTAccCopyClauseNode
    Token hiddenLiteralStringLparen; // in ASTAccCopyClauseNode
    IASTListNode<ASTAccDataItemNode> accDataList; // in ASTAccCopyClauseNode
    Token hiddenLiteralStringRparen; // in ASTAccCopyClauseNode
    ...
    {
        visitor.visitASTAccCopyClauseNode(this);
    ...
    @Override protected IASTNode getASTField(int index)
    {
        switch (index)
        {
        case 0:  return this.hiddenLiteralStringCopy;
    ...
    @Override protected void setASTField(int index, IASTNode value)
    {
        switch (index)
        {
        case 0:  this.hiddenLiteralStringCopy = (Token)value; if (value != null) value.setParent(this); return;
