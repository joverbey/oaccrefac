// Based on llloops.cpp from benchnt.zip; modified to compile with GCC
// (Jeff Overbey)
/************************************************************************
 *                                                                      *
...
#include <stdlib.h>
 ...
 /*COMPILER COMPILER COMPILER COMPILER COMPILER COMPILER COMPILER*/
    ...
    #define options   "(unknown optimisation)"
 #endif
...
void kernels()
 {
    ...
    */
    ...
    do
     {
        q = 0.0;
        for ( k=0 ; k<n ; k++ ) /*<<<<< 1178, 1, 1182, 1, Kernel3 */
        {
            q += z[k]*x[k];
        }     
