...
public class LoopInterchangeWizard extends RefactoringWizard {

    LoopInterchangeRefactoring m_refactoring;
    
    public LoopInterchangeWizard(LoopInterchangeRefactoring refactoring) {
    ...
    private class EmptyPage extends UserInputWizardPage {
        ...
        public void createControl(Composite parent) {
            ...
            new Label(c, SWT.NONE).setText("Loop Exchange Depth: ");
            ...
            inputUnroll.addModifyListener(new ModifyListener() {
                ...
                public void modifyText(ModifyEvent e) {
                    ...
                    if (newText.length() > 0) {
                        ...
                        if (isNumber(last)) {
                            m_refactoring.setExchangeDepth(Integer.parseInt(newText));
                        } else {
                            source.setText("");
                        }
                    }
