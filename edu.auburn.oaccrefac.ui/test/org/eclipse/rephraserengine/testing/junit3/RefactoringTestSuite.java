...
public abstract class RefactoringTestSuite<R extends CRefactoring> extends GeneralTestSuiteFromMarkers {
    ...
    public class IndividualRefactoringTestCase extends RefactoringTestCase<R> {
        ...
        public IndividualRefactoringTestCase(File fileContainingMarker, int markerOffset, String markerText, Class<R> refactoringClass, FilenameFilter filenameFilter) throws Exception {
            super(fileContainingMarker, markerOffset, markerText, filenameFilter);
            this.refactoringClass = refactoringClass;
        }

        @Override
        protected R createRefactoring(IFile file, TextSelection selection) throws Exception {
        ...
        protected boolean initializeRefactoring(LinkedList<String> markerFields) {
            RefactoringTestSuite.this.initializeRefactoring(markerFields);
            return super.initializeRefactoring(markerFields);
        }
     ...
     */
    protected void initializeRefactoring(LinkedList<String> markerFields) {
        ;
    }
