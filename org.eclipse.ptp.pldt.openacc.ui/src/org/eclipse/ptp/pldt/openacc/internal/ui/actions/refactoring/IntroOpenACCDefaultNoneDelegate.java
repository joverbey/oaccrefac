...
public class IntroOpenACCDefaultNoneDelegate extends RefactoringActionDelegate {
    ...
    public RefactoringWizard createWizard(Refactoring refactoring) {
        return new LoopRefactoringWizard(refactoring, "Introduce OpenACC Default None");
    }
