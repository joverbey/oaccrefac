/**********************************************************************
 * Copyright (c) 2007, 2011, 2012, 2016 IBM Corporation and University of Illinois.
 ...
 *******************************************************************************/
package org.eclipse.ptp.pldt.openacc.internal.ui.actions;
...
import org.eclipse.ptp.pldt.openacc.internal.ui.Activator;
import org.eclipse.ptp.pldt.openacc.internal.ui.IDs;
...
public class RunAnalyseOpenACCcommandHandler extends RunAnalyseHandlerBase {
	 ...
	 */
	private static final String VIEW_ID = "org.eclipse.ptp.pldt.openacc.ui.views.OpenACCArtifactView"; //$NON-NLS-1$

	/**
	 * ID for the extension point which allows plug-ins to contribute OpenMP artifact analyses based on language IDs.
	 */
	private static final String EXTENSION_POINT_ID = "org.eclipse.ptp.pldt.openacc.ui.artifactAnalysis"; //$NON-NLS-1$
