...
public class MergeDataConstructsDelegate extends RefactoringActionDelegate {

    @Override
    public CRefactoring createRefactoring(IWorkingCopy wc, ITextSelection selection, ICProject project) {
        return new MergeDataConstructsRefactoring(wc, selection, project);
    }

    @Override
    public RefactoringWizard createWizard(Refactoring refactoring) {
        return new LoopRefactoringWizard(refactoring, "Merge OpenAcc Data Constructs");
    }
