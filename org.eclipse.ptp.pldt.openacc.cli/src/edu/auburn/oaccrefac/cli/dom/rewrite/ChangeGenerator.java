/*******************************************************************************
 * Copyright (c) 2008, 2013, 2015 Institute for Software, HSR Hochschule fuer Technik
...
public class ChangeGenerator extends ASTVisitor {
	...
	private void generateChange(IASTNode rootNode, ASTVisitor pathProvider)
		...
		CustomTextChange subchange= ASTRewriteAnalyzer.createCustomTextChange(source);
